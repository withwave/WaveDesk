...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "구성"),
        ("config_acc", "데스크탑을 원격으로 제어하려면 WaveDesk에 \"접근성\" 권한을 부여해야 합니다."),
        ("config_screen", "데스크탑에 원격으로 액세스하려면 WaveDesk에 \"화면 녹화\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치 중..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("config_input", "키보드로 원격 데스크탑을 제어하려면 WaveDesk에 \"입력 모니터링\" 권한을 부여해야 합니다."),
        ("config_microphone", "원격으로 통화하려면 WaveDesk에 \"오디오 녹음\" 권한을 부여해야 합니다."),
        ...
        ("Send Alt+Ctrl+Arrow to remote as Ctrl+Arrow", "Alt+Ctrl+화살표를 원격에 Ctrl+화살표로 전송"),
