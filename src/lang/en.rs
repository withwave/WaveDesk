...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "In order to control your Desktop remotely, you need to grant WaveDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant WaveDesk \"Screen Recording\" permissions."),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant WaveDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant WaveDesk \"Record Audio\" permissions."),
