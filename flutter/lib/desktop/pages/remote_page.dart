...
class _RemotePageState extends State<RemotePage>
  ...
  void onWindowBlur() {
    ...
    // macOS grab release on blur is owned by _syncMacOSKeyboardGrab(), which
    // also drops the key focus node; calling enterOrLeave() directly here
    // would desync its _macOSInputActive bookkeeping. (WaveDesk)
    _syncMacOSKeyboardGrab();
