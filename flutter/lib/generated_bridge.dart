...
String sessionAddExistedSync({ required String id ,required UuidValue sessionId ,required Int32List displays ,required bool isViewCamera ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionAddExistedSyncConstMeta;

String sessionAddSync({ required UuidValue sessionId ,required String id ,required bool isFileTransfer ,required bool isViewCamera ,required bool isPortForward ,required bool isRdp ,required bool isTerminal ,required String switchUuid ,required bool forceRelay ,required String password ,required bool isSharedPassword ,String? connToken ,dynamic hint });
...
Stream<EventToUI> sessionStartWithDisplays({ required UuidValue sessionId ,required String id ,required Int32List displays ,dynamic hint });
...
Future<void> sessionLogin({ required UuidValue sessionId ,required String osUsername ,required String osPassword ,required String password ,required bool remember ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionLoginConstMeta;

Future<void> sessionSend2Fa({ required UuidValue sessionId ,required String code ,required bool trustThisDevice ,dynamic hint });
...
bool willSessionCloseCloseSession({ required UuidValue sessionId ,dynamic hint });
...
Future<void> sessionTogglePrivacyMode({ required UuidValue sessionId ,required String implKey ,required bool on ,dynamic hint });
...
Future<void> sessionSetFlutterOption({ required UuidValue sessionId ,required String k ,required String v ,dynamic hint });
...
Future<int?> sessionGetEdgeScrollEdgeThickness({ required UuidValue sessionId ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionGetEdgeScrollEdgeThicknessConstMeta;

Future<void> sessionSetEdgeScrollEdgeThickness({ required UuidValue sessionId ,required int value ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionSetEdgeScrollEdgeThicknessConstMeta;
...
FlutterRustBridgeTaskConstMeta get kSessionGetDisplaysAsIndividualWindowsConstMeta;

Future<void> sessionSetDisplaysAsIndividualWindows({ required UuidValue sessionId ,required String value ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionSetDisplaysAsIndividualWindowsConstMeta;

String? sessionGetUseAllMyDisplaysForTheRemoteSession({ required UuidValue sessionId ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionGetUseAllMyDisplaysForTheRemoteSessionConstMeta;
...
FlutterRustBridgeTaskConstMeta get kSessionSetUseAllMyDisplaysForTheRemoteSessionConstMeta;
...
Future<void> sessionSwitchDisplay({ required bool isDesktop ,required UuidValue sessionId ,required Int32List value ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionSwitchDisplayConstMeta;

Future<void> sessionHandleFlutterKeyEvent({ required UuidValue sessionId ,required String character ,required int usbHid ,required int lockModes ,required bool downOrUp ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionHandleFlutterKeyEventConstMeta;

Future<void> sessionHandleFlutterRawKeyEvent({ required UuidValue sessionId ,required String name ,required int platformCode ,required int positionCode ,required int lockModes ,required bool downOrUp ,dynamic hint });
...
Future<void> sessionInputKey({ required UuidValue sessionId ,required String name ,required bool down ,required bool press ,required bool alt ,required bool ctrl ,required bool shift ,required bool command ,dynamic hint });
...
Future<void> sessionOpenTerminal({ required UuidValue sessionId ,required int terminalId ,required int rows ,required int cols ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionOpenTerminalConstMeta;

Future<void> sessionSendTerminalInput({ required UuidValue sessionId ,required int terminalId ,required String data ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionSendTerminalInputConstMeta;

Future<void> sessionResizeTerminal({ required UuidValue sessionId ,required int terminalId ,required int rows ,required int cols ,dynamic hint });
...
Future<void> sessionPeerOption({ required UuidValue sessionId ,required String name ,required String value ,dynamic hint });
...
Future<void> sessionReadRemoteDir({ required UuidValue sessionId ,required String path ,required bool includeHidden ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionReadRemoteDirConstMeta;

Future<void> sessionSendFiles({ required UuidValue sessionId ,required int actId ,required String path ,required String to ,required int fileNum ,required bool includeHidden ,required bool isRemote ,required bool isDir ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionSendFilesConstMeta;

Future<void> sessionSetConfirmOverrideFile({ required UuidValue sessionId ,required int actId ,required int fileNum ,required bool needOverride ,required bool remember ,required bool isUpload ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionSetConfirmOverrideFileConstMeta;

Future<void> sessionRemoveFile({ required UuidValue sessionId ,required int actId ,required String path ,required int fileNum ,required bool isRemote ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionRemoveFileConstMeta;

Future<void> sessionReadDirToRemoveRecursive({ required UuidValue sessionId ,required int actId ,required String path ,required bool isRemote ,required bool showHidden ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionReadDirToRemoveRecursiveConstMeta;

Future<void> sessionRemoveAllEmptyDirs({ required UuidValue sessionId ,required int actId ,required String path ,required bool isRemote ,dynamic hint });
...
Future<void> sessionCreateDir({ required UuidValue sessionId ,required int actId ,required String path ,required bool isRemote ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionCreateDirConstMeta;

Future<String> sessionReadLocalDirSync({ required UuidValue sessionId ,required String path ,required bool showHidden ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionReadLocalDirSyncConstMeta;

Future<String> sessionReadLocalEmptyDirsRecursiveSync({ required UuidValue sessionId ,required String path ,required bool includeHidden ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionReadLocalEmptyDirsRecursiveSyncConstMeta;

Future<void> sessionReadRemoteEmptyDirsRecursiveSync({ required UuidValue sessionId ,required String path ,required bool includeHidden ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionReadRemoteEmptyDirsRecursiveSyncConstMeta;
...
Future<void> sessionAddJob({ required UuidValue sessionId ,required int actId ,required String path ,required String to ,required int fileNum ,required bool includeHidden ,required bool isRemote ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionAddJobConstMeta;

Future<void> sessionResumeJob({ required UuidValue sessionId ,required int actId ,required bool isRemote ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionResumeJobConstMeta;

Future<void> sessionRenameFile({ required UuidValue sessionId ,required int actId ,required String path ,required String newName ,required bool isRemote ,dynamic hint });
...
Future<void> sessionElevateWithLogon({ required UuidValue sessionId ,required String username ,required String password ,dynamic hint });
...
Future<void> sessionChangeResolution({ required UuidValue sessionId ,required int display ,required int width ,required int height ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionChangeResolutionConstMeta;

Future<void> sessionSetSize({ required UuidValue sessionId ,required int display ,required int width ,required int height ,dynamic hint });
...
Future<void> mainSetSocks({ required String proxy ,required String username ,required String password ,dynamic hint });
...
Future<String> mainDeployDevice({ required String token ,required String id ,dynamic hint });
...
Future<void> mainHttpRequest({ required String url ,required String method ,String? body ,required String header ,dynamic hint });
...
FlutterRustBridgeTaskConstMeta get kMainHandleWaylandScreencastRestoreTokenConstMeta;
...
/// - Android/iOS: no-op, always returns `false`
bool mainClipCursor({ required int left ,required int top ,required int right ,required int bottom ,required bool enable ,dynamic hint });
...
void mainSetPeerFlutterOptionSync({ required String id ,required String k ,required String v ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMainSetPeerFlutterOptionSyncConstMeta;

Future<void> mainSetPeerOption({ required String id ,required String key ,required String value ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMainSetPeerOptionConstMeta;

bool mainSetPeerOptionSync({ required String id ,required String key ,required String value ,dynamic hint });
...
Future<void> sessionAddPortForward({ required UuidValue sessionId ,required int localPort ,required String remoteHost ,required int remotePort ,dynamic hint });
...
Future<bool> mainSetPermanentPasswordWithResult({ required String password ,dynamic hint });
...
Future<void> mainInit({ required String appDir ,required String customClientConfig ,dynamic hint });
...
Future<void> sessionSetAuditGuid({ required UuidValue sessionId ,required String guid ,dynamic hint });
...
FlutterRustBridgeTaskConstMeta get kSessionOnWaitingForImageDialogShowConstMeta;

Future<void> sessionToggleVirtualDisplay({ required UuidValue sessionId ,required int index ,required bool on ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionToggleVirtualDisplayConstMeta;

Future<void> sessionPrinterResponse({ required UuidValue sessionId ,required int id ,required String path ,required String printerName ,dynamic hint });
...
Future<void> cmSwitchPermission({ required int connId ,required String name ,required bool enabled ,dynamic hint });
...
void sessionRegisterPixelbufferTexture({ required UuidValue sessionId ,required int display ,required int ptr ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionRegisterPixelbufferTextureConstMeta;

void sessionRegisterGpuTexture({ required UuidValue sessionId ,required int display ,required int ptr ,dynamic hint });
...
Future<void> sessionSetCommon({ required UuidValue sessionId ,required String key ,required String value ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionSetCommonConstMeta;

String? sessionGetCommonSync({ required UuidValue sessionId ,required String key ,required String param ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSessionGetCommonSyncConstMeta;

Future<String?> sessionGetCommon({ required UuidValue sessionId ,required String key ,required String param ,dynamic hint });
...
class RustdeskImpl implements Rustdesk {
                ...
                factory RustdeskImpl(ExternalLibrary dylib) => RustdeskImpl.raw(RustdeskPlatform(dylib));
...
Stream<String> startGlobalEventStream({ required String appType ,dynamic hint }) {
            ...
            callFfi: (port_) => _platform.inner.wire_start_global_event_stream(port_, arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kStartGlobalEventStreamConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> stopGlobalEventStream({ required String appType ,dynamic hint }) {
            ...
            callFfi: (port_) => _platform.inner.wire_stop_global_event_stream(port_, arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kStopGlobalEventStreamConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> hostStopSystemKeyPropagate({ required bool stopped ,dynamic hint }) {
            var arg0 = stopped;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_host_stop_system_key_propagate(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kHostStopSystemKeyPropagateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(connType);
        ...
        FlutterRustBridgeTaskConstMeta get kPeerGetSessionsCountConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = isViewCamera;
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_add_existed_sync(arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionAddExistedSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg11 = _platform.api2wire_opt_String(connToken);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_add_sync(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionAddSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(id);
        ...
        FlutterRustBridgeTaskConstMeta get kSessionStartConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_int_32_list(displays);
            return _platform.executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_start_with_displays(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_event_to_ui,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionStartWithDisplaysConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool?> sessionGetRemember({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_remember(port_, arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetRememberConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(arg);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_toggle_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_opt_box_autoadd_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetToggleOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(arg);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_get_toggle_option_sync(arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetToggleOptionSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(arg);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_option(port_, arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = remember;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_login(port_, arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionLoginConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = trustThisDevice;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send2fa(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSend2FaConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool sessionGetEnableTrustedDevices({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_get_enable_trusted_devices(arg0),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetEnableTrustedDevicesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool willSessionCloseCloseSession({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_will_session_close_close_session(arg0),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kWillSessionCloseCloseSessionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionClose({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionCloseConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_usize(display);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_refresh(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRefreshConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_usize(display);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_take_screenshot(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionTakeScreenshotConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(action);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_handle_screenshot(port_, arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionHandleScreenshotConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool sessionIsMultiUiSession({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionIsMultiUiSessionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = start;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_record_screen(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRecordScreenConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool sessionGetIsRecording({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetIsRecordingConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = forceRelay;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_reconnect(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionReconnectConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_toggle_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionToggleOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = on;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_toggle_privacy_mode(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionTogglePrivacyModeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(k);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_flutter_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetFlutterOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(v);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_flutter_option(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetFlutterOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
int getNextTextureKey({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kGetNextTextureKeyConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String getLocalFlutterOption({ required String k ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kGetLocalFlutterOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(v);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_set_local_flutter_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSetLocalFlutterOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String getLocalKbLayoutType({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kGetLocalKbLayoutTypeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> setLocalKbLayoutType({ required String kbLayoutType ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_set_local_kb_layout_type(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSetLocalKbLayoutTypeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String?> sessionGetViewStyle({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_view_style(port_, arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetViewStyleConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_view_style(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetViewStyleConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String?> sessionGetScrollStyle({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_scroll_style(port_, arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetScrollStyleConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_scroll_style(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetScrollStyleConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<int?> sessionGetEdgeScrollEdgeThickness({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_edge_scroll_edge_thickness(port_, arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetEdgeScrollEdgeThicknessConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_edge_scroll_edge_thickness(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetEdgeScrollEdgeThicknessConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String?> sessionGetImageQuality({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_image_quality(port_, arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetImageQualityConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_image_quality(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetImageQualityConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String?> sessionGetKeyboardMode({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_keyboard_mode(port_, arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetKeyboardModeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_keyboard_mode(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetKeyboardModeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String? sessionGetReverseMouseWheelSync({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_get_reverse_mouse_wheel_sync(arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetReverseMouseWheelSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_reverse_mouse_wheel(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetReverseMouseWheelConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String? sessionGetDisplaysAsIndividualWindows({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_get_displays_as_individual_windows(arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetDisplaysAsIndividualWindowsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_displays_as_individual_windows(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetDisplaysAsIndividualWindowsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String? sessionGetUseAllMyDisplaysForTheRemoteSession({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_get_use_all_my_displays_for_the_remote_session(arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetUseAllMyDisplaysForTheRemoteSessionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_use_all_my_displays_for_the_remote_session(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetUseAllMyDisplaysForTheRemoteSessionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<Int32List?> sessionGetCustomImageQuality({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_custom_image_quality(port_, arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetCustomImageQualityConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(mode);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_is_keyboard_mode_supported(arg0, arg1),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionIsKeyboardModeSupportedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_custom_image_quality(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetCustomImageQualityConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(fps);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_custom_fps(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetCustomFpsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<int?> sessionGetTrackpadSpeed({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_trackpad_speed(port_, arg0),
            parseSuccessData: _wire2api_opt_box_autoadd_i32,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetTrackpadSpeedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_trackpad_speed(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetTrackpadSpeedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionLockScreen({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionLockScreenConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionCtrlAltDel({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_ctrl_alt_del(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionCtrlAltDelConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_int_32_list(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_switch_display(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSwitchDisplayConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = downOrUp;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_handle_flutter_key_event(port_, arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionHandleFlutterKeyEventConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg5 = downOrUp;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_handle_flutter_raw_key_event(port_, arg0, arg1, arg2, arg3, arg4, arg5),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionHandleFlutterRawKeyEventConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = enter;
        ...
        FlutterRustBridgeTaskConstMeta get kSessionEnterOrLeaveConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg7 = command;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_input_key(port_, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionInputKeyConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_input_string(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionInputStringConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(text);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send_chat(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSendChatConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = api2wire_u32(cols);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_open_terminal(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionOpenTerminalConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(data);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send_terminal_input(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSendTerminalInputConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = api2wire_u32(cols);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_resize_terminal(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionResizeTerminalConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(terminalId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_close_terminal(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionCloseTerminalConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_peer_option(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionPeerOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(name);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_peer_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetPeerOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_input_os_password(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionInputOsPasswordConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = includeHidden;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_read_remote_dir(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionReadRemoteDirConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg7 = isDir;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send_files(port_, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSendFilesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg5 = isUpload;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_confirm_override_file(port_, arg0, arg1, arg2, arg3, arg4, arg5),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetConfirmOverrideFileConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = isRemote;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_remove_file(port_, arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRemoveFileConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = showHidden;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_read_dir_to_remove_recursive(port_, arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionReadDirToRemoveRecursiveConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = isRemote;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_remove_all_empty_dirs(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRemoveAllEmptyDirsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(actId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_cancel_job(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionCancelJobConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = isRemote;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_create_dir(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionCreateDirConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = showHidden;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_read_local_dir_sync(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionReadLocalDirSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = includeHidden;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_read_local_empty_dirs_recursive_sync(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionReadLocalEmptyDirsRecursiveSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = includeHidden;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_read_remote_empty_dirs_recursive_sync(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionReadRemoteEmptyDirsRecursiveSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = isRemote;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_platform(port_, arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetPlatformConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionLoadLastTransferJobs({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_load_last_transfer_jobs(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionLoadLastTransferJobsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg6 = isRemote;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_add_job(port_, arg0, arg1, arg2, arg3, arg4, arg5, arg6),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionAddJobConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = isRemote;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_resume_job(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionResumeJobConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = isRemote;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_rename_file(port_, arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRenameFileConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionElevateDirect({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_elevate_direct(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionElevateDirectConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(password);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_elevate_with_logon(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionElevateWithLogonConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionSwitchSides({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_switch_sides(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSwitchSidesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = api2wire_i32(height);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_change_resolution(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionChangeResolutionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = api2wire_usize(height);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_size(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetSizeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(sid);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send_selected_session_id(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSendSelectedSessionIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<List<String>> mainGetSoundInputs({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetSoundInputsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetLoginDeviceInfo({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetLoginDeviceInfoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainChangeId({ required String newId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainChangeIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetAsyncStatus({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetAsyncStatusConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String?> mainGetHttpStatus({ required String url ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_get_http_status(port_, arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetHttpStatusConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetOption({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetOptionSync({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetOptionSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetError({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetErrorConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetOptions({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetOptionsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetOptionsSync({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetOptionsSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainSetOptions({ required String json ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetOptionsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = testWithProxy;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_test_if_valid_server(port_, arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainTestIfValidServerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(password);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_socks(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetSocksConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainGetProxyStatus({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetProxyStatusConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<List<String>> mainGetSocks({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetSocksConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetAppName({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetAppNameConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetAppNameSync({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetAppNameSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainUriPrefixSync({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainUriPrefixSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetLicense({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetLicenseConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetVersion({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetVersionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<List<String>> mainGetFav({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetFavConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainStoreFav({ required List<String> favs ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainStoreFavConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetPeerSync({ required String id ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetPeerSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetLanPeers({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetLanPeersConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetConnectStatus({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetConnectStatusConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainCheckConnectStatus({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainCheckConnectStatusConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainIsUsingPublicServer({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_is_using_public_server(port_),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsUsingPublicServerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainDiscover({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainDiscoverConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetApiServer({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetApiServerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(id);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_deploy_device(port_, arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainDeployDeviceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainResolveAvatarUrl({ required String avatar ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainResolveAvatarUrlConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = _platform.api2wire_String(header);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_http_request(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainHttpRequestConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetLocalOption({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetLocalOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainGetUseTextureRender({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetUseTextureRenderConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetEnv({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetEnvConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_String(value);
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetEnvConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_local_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetLocalOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_handle_wayland_screencast_restore_token(port_, arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainHandleWaylandScreencastRestoreTokenConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetInputSource({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetInputSourceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_input_source(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetInputSourceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(y);
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetCursorPositionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = enable;
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_main_clip_cursor(arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kMainClipCursorConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetMyId({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetMyIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetUuid({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetUuidConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(key);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_get_peer_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetPeerOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(key);
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetPeerOptionSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(k);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_main_get_peer_flutter_option_sync(arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetPeerFlutterOptionSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(v);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_main_set_peer_flutter_option_sync(arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetPeerFlutterOptionSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_peer_option(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetPeerOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(value);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_main_set_peer_option_sync(arg0, arg1, arg2),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetPeerOptionSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(alias);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_peer_alias(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetPeerAliasConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetNewStoredPeers({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetNewStoredPeersConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainForgetPassword({ required String id ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(id);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_forget_password(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainForgetPasswordConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainPeerHasPassword({ required String id ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(id);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_peer_has_password(port_, arg0),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kMainPeerHasPasswordConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainPeerExists({ required String id ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainPeerExistsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainLoadRecentPeers({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainLoadRecentPeersConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainLoadRecentPeersForAb({ required String filter ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_load_recent_peers_for_ab(port_, arg0),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainLoadRecentPeersForAbConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainLoadFavPeers({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainLoadFavPeersConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainLoadLanPeers({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainLoadLanPeersConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainRemoveDiscovered({ required String id ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(id);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_remove_discovered(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainRemoveDiscoveredConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainChangeTheme({ required String dark ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainChangeThemeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainChangeLanguage({ required String lang ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_change_language(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainChangeLanguageConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainVideoSaveDirectory({ required bool root ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainVideoSaveDirectoryConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_user_default_option(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetUserDefaultOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetUserDefaultOption({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetUserDefaultOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainHandleRelayId({ required String id ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(id);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_handle_relay_id(port_, arg0),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainHandleRelayIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsOptionFixed({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsOptionFixedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetMainDisplay({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetMainDisplayConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetDisplays({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetDisplaysConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = api2wire_i32(remotePort);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_add_port_forward(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionAddPortForwardConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_i32(localPort);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_remove_port_forward(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRemovePortForwardConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionNewRdp({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionNewRdpConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionRequestVoiceCall({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_request_voice_call(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRequestVoiceCallConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionCloseVoiceCall({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_close_voice_call(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionCloseVoiceCallConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String? sessionGetConnToken({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetConnTokenConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = accept;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_cm_handle_incoming_voice_call(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kCmHandleIncomingVoiceCallConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> cmCloseVoiceCall({ required int id ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmCloseVoiceCallConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(device);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_set_voice_call_input_device(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSetVoiceCallInputDeviceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> getVoiceCallInputDevice({ required bool isCm ,dynamic hint }) {
            var arg0 = isCm;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_get_voice_call_input_device(port_, arg0),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kGetVoiceCallInputDeviceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetLastRemoteId({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetLastRemoteIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainGetSoftwareUpdateUrl({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_get_software_update_url(port_),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetSoftwareUpdateUrlConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetHomeDir({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetHomeDirConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetLangs({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetLangsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetTemporaryPassword({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_get_temporary_password(port_),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetTemporaryPasswordConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainSetPermanentPasswordWithResult({ required String password ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_permanent_password_with_result(port_, arg0),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetPermanentPasswordWithResultConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetFingerprint({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetFingerprintConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> cmGetClientsState({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmGetClientsStateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String?> cmCheckClientsLength({ required int length ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_cm_check_clients_length(port_, arg0),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kCmCheckClientsLengthConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<int> cmGetClientsLength({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmGetClientsLengthConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(customClientConfig);
        ...
        FlutterRustBridgeTaskConstMeta get kMainInitConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "main_init",
...
Future<void> mainDeviceId({ required String id ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainDeviceIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainDeviceName({ required String name ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainDeviceNameConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainRemovePeer({ required String id ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainRemovePeerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainHasHwcodec({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainHasHwcodecConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainHasVram({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainHasVramConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainSupportedHwdecodings({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSupportedHwdecodingsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainIsRoot({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsRootConstMeta => const FlutterRustBridgeTaskConstMeta(
...
int getDoubleClickTime({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kGetDoubleClickTimeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainStartDbusServer({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainStartDbusServerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainSaveAb({ required String json ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSaveAbConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainClearAb({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainClearAbConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainLoadAb({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainLoadAbConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainSaveGroup({ required String json ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSaveGroupConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainClearGroup({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainClearGroupConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainLoadGroup({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainLoadGroupConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(msg);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send_pointer(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSendPointerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(msg);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send_mouse(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSendMouseConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionRestartRemoteDevice({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_restart_remote_device(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRestartRemoteDeviceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(typ);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_get_audit_server_sync(arg0, arg1),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetAuditServerSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(note);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_send_note(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSendNoteConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String sessionGetLastAuditNote({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetLastAuditNoteConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(guid);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_audit_guid(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetAuditGuidConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String sessionGetAuditGuid({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetAuditGuidConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String sessionGetConnSessionId({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetConnSessionIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> sessionAlternativeCodecs({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_alternative_codecs(port_, arg0),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionAlternativeCodecsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionChangePreferCodec({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_change_prefer_codec(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionChangePreferCodecConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sessionOnWaitingForImageDialogShow({ required UuidValue sessionId ,dynamic hint }) {
            var arg0 = _platform.api2wire_Uuid(sessionId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_on_waiting_for_image_dialog_show(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionOnWaitingForImageDialogShowConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = on;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_toggle_virtual_display(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionToggleVirtualDisplayConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = _platform.api2wire_String(printerName);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_printer_response(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionPrinterResponseConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainSetHomeDir({ required String home ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetHomeDirConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetDataDirIos({ required String appDir ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetDataDirIosConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainStopService({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainStopServiceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainStartService({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainStartServiceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainUpdateTemporaryPassword({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_update_temporary_password(port_),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainUpdateTemporaryPasswordConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainCheckSuperUserPermission({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_check_super_user_permission(port_),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kMainCheckSuperUserPermissionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetUnlockPin({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetUnlockPinConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainSetUnlockPin({ required String pin ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetUnlockPinConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainCheckMouseTime({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainCheckMouseTimeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<double> mainGetMouseTime({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetMouseTimeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainWol({ required String id ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainWolConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "main_wol",
            argNames: ["id"],
        );
...
Future<void> mainCreateShortcut({ required String id ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(id);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_create_shortcut(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainCreateShortcutConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(msg);
        ...
        FlutterRustBridgeTaskConstMeta get kCmSendChatConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = res;
        ...
        FlutterRustBridgeTaskConstMeta get kCmLoginResConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> cmCloseConnection({ required int connId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmCloseConnectionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> cmRemoveDisconnectedConnection({ required int connId ,dynamic hint }) {
            var arg0 = api2wire_i32(connId);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_cm_remove_disconnected_connection(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kCmRemoveDisconnectedConnectionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> cmCheckClickTime({ required int connId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmCheckClickTimeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<double> cmGetClickTime({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmGetClickTimeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = enabled;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_cm_switch_permission(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kCmSwitchPermissionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool cmCanElevate({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmCanElevateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> cmElevatePortable({ required int connId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmElevatePortableConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> cmSwitchBack({ required int connId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmSwitchBackConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> cmGetConfig({ required String name ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmGetConfigConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetBuildDate({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetBuildDateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(locale);
        ...
        FlutterRustBridgeTaskConstMeta get kTranslateConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "translate",
...
var arg1 = api2wire_usize(display);
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetRgbaSizeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_usize(display);
        ...
        FlutterRustBridgeTaskConstMeta get kSessionNextRgbaConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = api2wire_usize(ptr);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_register_pixelbuffer_texture(arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRegisterPixelbufferTextureConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = api2wire_usize(ptr);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_register_gpu_texture(arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRegisterGpuTextureConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> queryOnlines({ required List<String> ids ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kQueryOnlinesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
int versionToNumber({ required String v ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kVersionToNumberConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> optionSynced({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kOptionSyncedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsInstalled({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsInstalledConstMeta => const FlutterRustBridgeTaskConstMeta(
...
void mainInitInputSource({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainInitInputSourceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsInstalledLowerVersion({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsInstalledLowerVersionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsInstalledDaemon({ required bool prompt ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsInstalledDaemonConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsProcessTrusted({ required bool prompt ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsProcessTrustedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsCanScreenRecording({ required bool prompt ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsCanScreenRecordingConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsCanInputMonitoring({ required bool prompt ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsCanInputMonitoringConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsShareRdp({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsShareRdpConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainSetShareRdp({ required bool enable ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetShareRdpConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainGotoInstall({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGotoInstallConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetNewVersion({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetNewVersionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainUpdateMe({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainUpdateMeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> setCurSessionId({ required UuidValue sessionId ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSetCurSessionIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool installShowRunWithoutInstall({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kInstallShowRunWithoutInstallConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> installRunWithoutInstall({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_install_run_without_install(port_),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kInstallRunWithoutInstallConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(path);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_install_install_me(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kInstallInstallMeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String installInstallPath({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kInstallInstallPathConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String installInstallOptions({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kInstallInstallOptionsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = rememberMe;
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_account_auth(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainAccountAuthConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainAccountAuthCancel({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainAccountAuthCancelConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainAccountAuthResult({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainAccountAuthResultConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainOnMainWindowClose({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainOnMainWindowCloseConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainCurrentIsWayland({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainCurrentIsWaylandConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainIsLoginWayland({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainIsLoginWaylandConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainHideDock({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainHideDockConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainHasFileClipboard({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainHasFileClipboardConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainHasGpuTextureRender({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainHasGpuTextureRenderConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> cmInit({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kCmInitConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "cm_init",
            argNames: [],
        );
...
Future<void> mainStartIpcUrlServer({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainStartIpcUrlServerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainTestWallpaper({ required int second ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainTestWallpaperConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainSupportRemoveWallpaper({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_support_remove_wallpaper(port_),
            parseSuccessData: _wire2api_bool,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSupportRemoveWallpaperConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isIncomingOnly({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsIncomingOnlyConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isOutgoingOnly({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsOutgoingOnlyConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isCustomClient({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsCustomClientConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isDisableSettings({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsDisableSettingsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isDisableAb({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsDisableAbConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isDisableAccount({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsDisableAccountConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isDisableGroupPanel({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsDisableGroupPanelConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isDisableInstallation({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsDisableInstallationConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> isPresetPassword({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsPresetPasswordConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isPresetPasswordMobileOnly({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsPresetPasswordMobileOnlyConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> sendUrlScheme({ required String url ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSendUrlSchemeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isSupportMultiUiSession({ required String version ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsSupportMultiUiSessionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool isSelinuxEnforcing({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kIsSelinuxEnforcingConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainDefaultPrivacyModeImpl({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainDefaultPrivacyModeImplConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainSupportedPrivacyModeImpls({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSupportedPrivacyModeImplsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainSupportedInputSource({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainSupportedInputSourceConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGenerate2Fa({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGenerate2FaConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> mainVerify2Fa({ required String code ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainVerify2FaConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainHasValid2FaSync({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainHasValid2FaSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainVerifyBot({ required String token ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainVerifyBotConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainHasValidBotSync({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainHasValidBotSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetHardOption({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetHardOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetBuildinOption({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetBuildinOptionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainCheckHwcodec({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainCheckHwcodecConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetTrustedDevices({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetTrustedDevicesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainRemoveTrustedDevices({ required String json ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(json);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_remove_trusted_devices(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainRemoveTrustedDevicesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> mainClearTrustedDevices({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_clear_trusted_devices(port_),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainClearTrustedDevicesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
int mainMaxEncryptLen({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainMaxEncryptLenConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = api2wire_usize(display);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_request_new_display_init_msgs(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionRequestNewDisplayInitMsgsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool mainAudioSupportLoopback({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainAudioSupportLoopbackConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetPrinterNames({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetPrinterNamesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> mainGetCommon({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetCommonConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String mainGetCommonSync({ required String key ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kMainGetCommonSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_main_set_common(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMainSetCommonConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(value);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_set_common(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionSetCommonConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(param);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_session_get_common_sync(arg0, arg1, arg2),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetCommonSyncConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg2 = _platform.api2wire_String(param);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_session_get_common(port_, arg0, arg1, arg2),
            parseSuccessData: _wire2api_opt_String,
        ...
        FlutterRustBridgeTaskConstMeta get kSessionGetCommonConstMeta => const FlutterRustBridgeTaskConstMeta(
...
EventToUI _wire2api_event_to_ui(dynamic raw) {
            switch (raw[0]) {
                case 0: return EventToUI_Event(_wire2api_String(raw[1]),);
case 1: return EventToUI_Rgba(_wire2api_usize(raw[1]),);
case 2: return EventToUI_Texture(_wire2api_usize(raw[1]),_wire2api_bool(raw[2]),);
